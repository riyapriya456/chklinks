...
async def start_handler(_, event: Message):
	await event.reply_photo("https://graph.org/file/4bf03621c01b9fba1e09c.jpg",
                                caption=Config.START_MSG.format(event.from_user.mention),
                                reply_markup=InlineKeyboardMarkup([
					[InlineKeyboardButton('HELP', url='https://t.me/+MnDYpcPswdtkZWNi')],
					[InlineKeyboardButton("DISCUSSION", url="https://t.me/+MnDYpcPswdtkZWNi")],
